...
router.post('/quiz/:id(\\d+)', quizController.checkAnswers);
router.get('/quiz/:id(\\d+)/addtag', adminMiddleware, quizController.addTag);
router.post('/quiz/:id(\\d+)/addtag', adminMiddleware, quizController.postAddTag);
...
router.get('/tag/modifytag', adminMiddleware, tagController.modifyTag);
router.post('/tag/modifytag', adminMiddleware, tagController.postModifyTag);
router.post('/tag/deletetag', adminMiddleware, tagController.postDeleteTag);
